          ...
          <div className="columns">
            <div className="column is-half mb-4">
              <p className="about-us-text has-text-justified">
                ...
                productos Baldor, ABB, Dodge, etc y diversas horas en proyectos
                de automatización, me han ayudado a...
              </p>
              ...
              <p className="about-us-text has-text-justified mt-6">
                ...
                los requerimientos{' '}
                <b>eléctrico, electrónico y de transmisión de potencia</b> para
                la <b>industria</b> en <b>general</b> con equipos monofásicos y
                trifásicos en CA & NEMA/IEC, media tensión, uso inversor, motor
                AC de imán permanente &ldquo;SyMax&rdquo;, con freno, para
